...
/**
 * Generated class for the GoogleCalendarPage page.
 *
...
export class GoogleCalendarPage {
  ...
  // ionViewDidLoad() {
  //   console.log('ionViewDidLoad GoogleCalendarPage');
  // }
  calendarEvent:any = {};
    attendees = [{
       email:""
    ...
    validation:any = {};
    CLIENT_ID = '1071430120392-ddo4eeu2qopcf9o7uq8l3dg8pflbqjgj.apps.googleusercontent.com'; // Client ID of your google console project
    SCOPES = ["https://www.googleapis.com/auth/calendar"];
    APIKEY = "AIzaSyCQ9eR-7ii1CTyNlRuMf0UdVGB9LHwMUWc"; // API key of your google console project
    REDIRECTURL = "http://localhost/callback";
    // localhost/callback#access_token=ya29.a0ARrdaM8X7WHqctTsrP_2m4tDnhJVvT6HyzdP21xnTC93AC2hNr5J9PaocFU3dgm71mAYLF92I28FiDD3ic6qbJAZ-ugkhcyZ2emokzxAPl66hE67yTenxf8usuxjeWvzIbbHx1rSJRz2AdUb8IHnVQOA1Gbw&token_type=Bearer&expires_in=3599&scope=https://www.googleapis.com/auth/calendar
    sendInvite() {
        if(!this.validate()) {
